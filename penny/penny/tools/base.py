...
class ToolExecutor:
    ...
    def _find_similar_tool(self, called_name: str) -> str | None:
        ...
        1. 'call_' prefix: the model mirrors tool-call ID format
           (e.g., 'call_browse' when 'browse' is registered).
        2. Close name: the model invents a plausible-sounding name similar to
           an existing tool (e.g., 'collection_update_entry' when 'update_entry'
           is registered, or 'read_newest' when 'read_latest' exists).
        """
