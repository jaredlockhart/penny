...
from penny.responses import AGENT_EMPTY_RESPONSE, AGENT_MAX_STEPS, AGENT_MODEL_ERROR
    ...
    async def run(
        ...
        for step in range(steps):
            ...
            try:
                ...
                return ControllerResponse(answer=AGENT_MODEL_ERROR)
            ...
            if not content:
                ...
                return ControllerResponse(answer=AGENT_EMPTY_RESPONSE)
