...
class Prompt:
    ...
    CONVERSATION_PROMPT = (
        ...
        "- If the question needs specific facts, names, dates, or current information, "
        "search the web\n"
        "- If something is worth remembering, use think to note it\n"
        "- If a topic deserves deeper research, use learn\n\n"
        "IMPORTANT: Never make up news, events, facts, names, dates, or product details. "
        "If you don't know something specific — even historical facts — search for it. "
        "Only share information that comes from your injected context or from tool results. "
        "Do not add details, names, dates, or facts from your training memory.\n\n"
