...
"""
    ...
    INNER_MONOLOGUE_SYSTEM_PROMPT = (
        ...
        "Every tool call has a `reasoning` field — use it to think out loud. "
        "Explain what you're looking for, what you already know, "
        "and what you'll do with the result. This is your inner monologue; "
        "it gets persisted as your thought stream.\n\n"
    ...
    ORIENTATION_PROMPT = (
        "Review the context above. Pick ONE topic to focus on this cycle — "
        "something the user cares about that might have new developments.\n\n"
        "Check your recent thoughts to avoid repeating what you already explored. "
        "Rotate across the user's interests.\n\n"
        "Write a short paragraph: what's your single objective, "
        "and why might the user want to hear about it?"
    )

    INNER_MONOLOGUE_BEGIN_PROMPT = (
        "Execute your thinking cycle plan. Use your tools to explore, research, and "
        "optionally message the user if you find something they'd genuinely enjoy."
    )
