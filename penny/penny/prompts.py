...
class Prompt:
    ...
    CONVERSATION_PROMPT = (
        ...
        "Never refuse a request or say you can't help. If search returns no results "
        "or fails, use what you know from context or offer a relevant observation — "
        "always give the user something useful, even if it's just a follow-up question.\n\n"
